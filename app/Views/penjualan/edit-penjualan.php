                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST"action="<?= site_url('update-penjualan');?>">
                      <div class="form-group">
                        <label for="exampleInputnamapenjualan1">Kode Penjualan</label>
                        <input class="form-control" name="id_penjualan" type="hidden" value="<?=$penjualan[0]['id_penjualan'];?>">
                        <input class="form-control" name="txtPenjualan" type="text" placeholder="Nama Penjualan"value="<?=$penjualan[0]['no_faktur'];?>">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputnofaktur1">No Faktur</label>
                        <input class="form-control" name="txtNoFaktur" type="text" placeholder="No Faktur"value="<?=$penjualan[0]['no_faktur'];?>">
                      </div>
                      <div class="form-group">
